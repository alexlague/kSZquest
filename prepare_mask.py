...
ivar_file = f"{kutils.act_root}/act_dr5.01_s08s18_AA_f090_night_ivar.fits"
mask_file = f"{kutils.planck_root}HFI_Mask_GalPlane-apo0_2048_R2.00.fits"
...
enmap.write_map(f"{kutils.out_dir}/planck_galactic_mask_070.fits",gmask)
